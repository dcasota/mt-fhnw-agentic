-- =============================================================================
--  Migration 0008: allow checkpoint 'bookkit' in audit_verdicts
-- =============================================================================
--  ADR-0041 (every `agentic check` records its verdict): the new
--  `agentic check bookkit` gate (deliverable bookkit-polishing audit:
--  bold-emphasis limit + content English-only) records checkpoint "bookkit".
