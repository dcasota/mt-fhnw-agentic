-- =============================================================================
--  Migration 0010: allow five new checkpoint names in audit_verdicts
-- =============================================================================
--  ADR-0044 (codify the residual academic-research-skills topics as gates):
--  five new gates promote previously-uncodified ARS capabilities into the
--  boot/close gate sequence:
--    integrity, figure_quality, disclosure, rr_matrix, calibration
