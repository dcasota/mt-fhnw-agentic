...
pub fn assemble_empty_template() -> Vec<PackagePart> {
    ...
    let customxml_item1_rels =
        include_bytes!("../tests/fixtures/empty_customxml_item1_rels.xml").to_vec();
    let customxml_itemprops =
        include_bytes!("../tests/fixtures/empty_customxml_itemprops1.xml").to_vec();
    ...
    vec![
        PackagePart::new(
            "[Content_Types].xml",
            crate::content_types::emit_content_types_xml(),
        ),
        ...
        PackagePart::new(
            ...
            crate::web_settings::emit_web_settings_xml(),
        ),
...
mod tests {
    ...
    fn logo_part_has_expected_size() {
        ...
        let logo = parts
            .iter()
            .find(|p| p.path == "word/media/image1.png")
            .expect("logo present");
